...
def plot_system_with_trajectory(trajectory, root_X):
    ...
    plt.plot(x1_circle, x2_circle, label='$x_1^2 + x_2^2 - 4 = 0$ (Коло)', color='blue', linewidth=2, alpha=0.6)
    plt.plot(x1_line, x2_line, label='$x_1 - x_2 = 0$ (Пряма)', color='red', linewidth=2, alpha=0.6)
